    ...
    <>
      <li>
        <NavLink
          to="/"
          className={({ isActive }) =>
            isActive ? 'text-orange-500 font-bold' : 'text-gray-500 font-bold'
          }
        >
          Home
        </NavLink>
    ...
    <div className="navbar bg-base-100 shadow-sm md:px-8 pb-4">
      <div className="navbar-start">
        ...
        <div className="flex text-2xl font-bold items-center pt-3 text-blue-900">
          ...
          ATHLOF<span className="text-orange-600 text-5xl">Y</span>
        </div>
      </div>
      ...
      <div className="navbar-end gap-3">
        {user ? (
          <>
            ...
            <button onClick={handleLogOut} className="btn btn-outline bg-red-500 text-white btn-sm">
              Logout
            </button>
          </>
        ) : (
